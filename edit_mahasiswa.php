...
include 'koneksi.php';
$nim=$_GET['nim'];
$query=mysqli_query($link,"SELECT * from mahasiswa where nim=$nim");
...
<center>
<form class="form-edit" method="POST" enctype="multipart/form-data" action="form_edit1.php">
    <div class="edit">
        <div class="edit-container">
            <input type="hidden" name="nim" value="<?php echo $row['nim']; ?>"></br>
            ...
            Tanggal Lahir :<br><input type="date" name="lahir" placeholder="lahir"
            value="<?php echo $row['lahir']; ?>"></br>
            ...
            Asal Sekolah:<br><input type="text" name="sekolah" placeholder="sekolah"
            value="<?php echo $row['sekolah']; ?>"></br>

            Foto:<br><input type="file" name="foto" placeholder="foto"
            value="<?php echo $row['foto']; ?>"></br>
