...
$query = mysqli_query($link, "UPDATE mahasiswa SET nama='$nama', kelamin='$kelamin', lahir='$lahir', alamat='$alamat', agama='$agama', sekolah='$sekolah', foto='$foto' WHERE nim='$nim'")
or die(mysqli_error($link));

if($query){
    echo"Proses edit berhasi, tampil data 
    <a href = 'data_mahasiswa.php'> disini </a>";
}
else{
