...
<html lang="en">
  ...
  <header>
    ...
    <div>
        ...
        <form role="form" action="insert_kehadiran.php" method="post" enctype="multipart/form-data" class="form-tambah">
            <div class="tambah">
            <div class="login-container">
                ...
                <button href="tampil_kehadiran.php" type="submit">Tambah Data</button><br><br>
            </div>
            </div>
