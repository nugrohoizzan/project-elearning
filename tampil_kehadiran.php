...
<html lang="en">
  ...
  <header>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="kehadiran.php">Input Kehadiran</a>
              </li>
    ...
    ?>
    <form method="POST" enctype="multipart/form-data" action="tampil_kehadiran.php"> 
        <div class="row">
            <div class=>
                ...
                <table>
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="detail_kehadiran.php?kode=<?php echo $row['kode'];?>" role="button">Detail</a></td>
                            </tr>
                ...
                <br><br>
                <button class="tambah">
                    <a href="kehadiran.php"> Tambah Jadwal Mengajar </a>
                </button>
                <br><br>
                <button class="batal">
