...
<html lang="en">
  ...
  <header>
    ...
    $query = "SELECT * FROM mengajar WHERE hari='$hari'";
    $result = mysqli_query($link, $query);
    ?>
    <form method="POST" enctype="multipart/form-data" action="tampil_mengajar.php"> 
        <form class="row">
            <div class=>
                ...
                <table>
                        <tr>
                            <td><select name="hari" placeholder="hari" value="hari">
                                <option>Senin</option>
                            ...
                            <td><select name="tahun" placeholder="tahun" value="tahun">
